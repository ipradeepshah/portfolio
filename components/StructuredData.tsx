...
export default function StructuredData() {
  ...
  const person = {
    ...
    image: {
      ...
      height: 800,
      caption:
        "Pradeep Shah — CEO of Siyaram Hardware & Suppliers and Founder of Standard ERP",
    },
    description:
      "Pradeep Shah is a Computer Engineer from Kurukshetra University, CEO of Siyaram Hardware & Suppliers in Birgunj, Nepal, and Founder of Standard ERP — building next-generation business management software for small and medium businesses.",
    ...
    hasOccupation: [
      {
        ...
        description:
          "CEO of Siyaram Hardware & Suppliers, a hardware and construction materials business in Birgunj, Nepal.",
      },
      {
        "@type": "Occupation",
        ...
        description:
          "Founder and developer of Standard ERP, a business management software for SMEs in Nepal.",
      },
    ],
    worksFor: {
      "@type": "Organization",
  ...
  const hardware = {
    ...
    url: `${BASE}/siyaram-hardware`,
    description:
      "Siyaram Hardware & Suppliers is a leading hardware and construction materials business in Birgunj, Nepal. We supply construction materials, hardware tools, plumbing supplies, electrical supplies, and industrial products to contractors, builders, and local businesses.",
    ...
    hasOfferCatalog: {
      ...
      itemListElement: [
        {
          "@type": "Offer",
          itemOffered: { "@type": "Product", name: "Construction Materials" },
        },
        {
          "@type": "Offer",
          itemOffered: { "@type": "Product", name: "Hardware Tools" },
        },
        {
          "@type": "Offer",
          itemOffered: { "@type": "Product", name: "Plumbing Supplies" },
        },
        {
          "@type": "Offer",
          itemOffered: { "@type": "Product", name: "Electrical Supplies" },
        },
        {
          "@type": "Offer",
          itemOffered: { "@type": "Product", name: "Industrial Products" },
        },
      ],
    },
    sameAs: [
  ...
  const erp = {
    ...
    description:
      "Standard ERP is a business management software platform for small and medium businesses in Nepal — integrating accounting, inventory management, billing, and reporting into a single easy-to-use platform.",
  ...
  const website = {
    ...
    url: `${BASE}/`,
    description:
      "Personal portfolio and business website of Pradeep Shah — CEO of Siyaram Hardware & Suppliers and Founder of Standard ERP, Birgunj, Nepal.",
    publisher: {
      "@type": "Person",
      "@id": `${BASE}/#pradeep-shah`,
      name: "Pradeep Shah",
  ...
  const breadcrumbs = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 3,
        name: "Siyaram Hardware",
        item: `${BASE}/siyaram-hardware`,
      },
      {
        "@type": "ListItem",
        position: 4,
        name: "Standard ERP",
        item: `${BASE}/standard-erp`,
      },
  ...
  return (
    <>
      ...
      <div style={{ display: "none" }} aria-hidden="true">
        <a rel="me" href="https://www.linkedin.com/in/ipradeepshah/">
          LinkedIn
        </a>
        <a rel="me" href="https://x.com/i_pradeepshah">
          Twitter/X
        </a>
        <a rel="me" href="https://www.instagram.com/i_pradeepshah">
          Instagram
        </a>
        <a rel="me" href="https://www.tiktok.com/@ipradeepshah">
          TikTok
        </a>
        <a rel="me" href="https://github.com/ipradeepshah">
          GitHub
        </a>
        <a rel="me" href="https://www.facebook.com/ipradeepshah/">
          Facebook
        </a>
